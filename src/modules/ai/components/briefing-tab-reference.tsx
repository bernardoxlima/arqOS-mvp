...
/**
 * Briefing Tab - Reference
 * Generates AI image prompts for visual references from memorial
 */
...
interface BriefingTabReferenceProps {
...
export function BriefingTabReference({
  memorial,
  referencePrompt,
  isLoading,
  error,
  onGenerate,
}: BriefingTabReferenceProps) {
      ...
      {!hasMemorial && (
        <div className="rounded-md bg-muted p-4 text-center">
          <p className="text-sm text-muted-foreground">
            Primeiro, gere o memorial na aba &quot;Memorial&quot; para poder criar o prompt de referencias.
          </p>
        </div>
      )}
      ...
      {referencePrompt && (
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <label className="text-sm font-medium">Prompt de Referencias Visuais</label>
            <Button
              variant="ghost"
              size="sm"
              onClick={handleCopy}
